...
const ExternalLinkIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-5 h-5">
    <path strokeLinecap="round" strokeLinejoin="round" d="M18 13.5V18A2.25 2.25 0 0 1 15.75 20.25H6.75A2.25 2.25 0 0 1 4.5 18V8.25A2.25 2.25 0 0 1 6.75 6h4.5M15 3h6v6m-11.25 9L21 3" />
  </svg>
)
                  ...
                  <div className="flex gap-4 mt-6">
                    {p.github && (
                      <a href={p.github} target="_blank" rel="noreferrer"
                        className="inline-flex items-center gap-1 text-sm font-medium text-white hover:text-indigo-300 transition">
                        <GithubIcon /> Code
                      </a>
                    )}
                    {p.link && (
